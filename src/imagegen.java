...
public class imagegen {
    public String imagegenmain() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .method("POST", HttpRequest.BodyPublishers.ofString("prompt=test&id=12345&width=768&height=768&inferenceSteps=50&guidanceScale=7.5&img2img_strength=0.75"))
                .build();
